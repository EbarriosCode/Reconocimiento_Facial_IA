...
cascPath = "C:/Users/ebarr/Desktop/Reconocimiento_Facial/Cascades/haarcascade_frontalface_default.xml"
...
while(True):
    ...
    for(x,y,w,h) in rostro:
       ...
       # cv2.imwrite("images/Eduardo/Eduardo_"+str(count)+".jpg", grises[y:y+h, x:x+w])
        cv2.imwrite("images/Eduardo/Eduardo"+str(count)+".jpg", grises[y:y+h, x:x+w])
